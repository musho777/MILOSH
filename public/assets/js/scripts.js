...
const wrapper = document.querySelector(".wrapper"),
    selectBtn = wrapper.querySelector(".search__btn"),
...
searchInp.addEventListener("keyup", () => {
    ...
    options.innerHTML = arr ? arr : `<p style="margin-top: 10px;">Такого города у нас нет</p>`;
});
...
// Поиск
const searchWrapper = document.querySelector(".hero__search-input");
